		...
		} else 
		{
			...
			<div class="top-header">
				<div class="container">
					...
					<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
						<li class="tol">Toll Number : +250 789209482 </li>        
		...
		<div class="container">
			<nav class="navbar navbar-inverse" role="navigation">
				<div class="navbar-header adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
					<a href="#" class="navbar-brand scroll-top logo"><b>RWANDA GLOBAL TRAVELS</b></a>
		...
		<div class="banner-container" style="height: 300px;">
			...
			<div class="container banner-content">
				<div id="da-slider" class="da-slider">
					<div class="da-slide">
						<h2>Tour Packages</h2>
						<p>Get your plans right away.. en<span class="style1"></span>joy!!!</p>
